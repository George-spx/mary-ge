...
public class EditDistance {
    ...
    public static int iterativeStringDistance(String s1, String s2) throws EditDistanceException {
      if(s1 == null || s2 == null){
        throw new EditDistanceException("Strings cannot be null");
      }
        int bestHit = 0;
        s1=s1.toLowerCase();
        s2=s2.toLowerCase();
    ...
    public static int stringDistance(String s1, String s2)throws EditDistanceException{
      if(s1 == null || s2 == null){
        throw new EditDistanceException("Strings cannot be null");
      }
        if (s1.isEmpty()) {
