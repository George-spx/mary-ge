...
public class Sort <T>{
     ...
     */
    public void mergeSort(ArrayList<T> array, Comparator<T> comparator) throws SortException{
      if(array == null){
     ...
     */
    private void merge(ArrayList<T> array, Comparator<T> comparator, int start, int middle, int end) {
        int left = 0;
        int right = 0;
